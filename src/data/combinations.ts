...
export const COMBINATIONS: Combination[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    cards: ["samurai","kitsune","rollick","daimyo","ninja","tanuki","mountain-shrine","tea-house","approach","litter"],
    strategy: "Samurai stays in play generating +1 Coin each turn while forcing opponents to discard to 3 repeatedly. Kitsune is a village-Attack with flexible choices. Daimyo is a powerful Duration that replays your next Action. Ninja combines draw with hand attack. Tanuki upgrades cards by exactly 2. Rollick is a free Village that also gains an Action on buy.",
    keyCards: ["samurai","daimyo","kitsune"],
    difficulty: "advanced",
  ...
  },
  {
    ...
    name: "Shrine Circuit",
    expansions: ["rising-sun"],
    cards: ["river-shrine","mountain-shrine","foresight","approach","kitsune","snake-witch","artist","craftsman","village-green","tea-house"],
    strategy: "River Shrine trashes junk early then rewards a no-buy turn by gaining a card costing up to 4. Mountain Shrine trashes for coins and draws when there are Actions in the trash. Foresight digs for Actions and shuffles the rest back. Village Green is a Duration/Reaction that provides a village effect either now or next turn. Artist draws based on near-empty supply piles.",
    keyCards: ["river-shrine","mountain-shrine","village-green"],
    difficulty: "intermediate",
    tags: ["thinning","draw","duration"],
  },
  {
    id: "rising-sun-003",
    name: "Daimyo's Court",
    expansions: ["rising-sun"],
    cards: ["daimyo","warlord","samurai","ninja","rollick","litter","tanuki","tea-house","approach","village-green"],
    strategy: "Warlord is a Duration Attack that locks opponents out of cards they have 2+ copies of in play — devastating against engine players. Daimyo's replay effect chains well with Ninja's draw. Litter is a cheap Village that also gains 2 Horses. Tanuki converts cards into something better. Approach pairs well with other village effects.",
    keyCards: ["daimyo","warlord","samurai"],
    difficulty: "advanced",
    tags: ["attack","duration","engine"],
  },
